            ...
            {loading ? (
                ...
                <div className="flex h-24 bg-gray-50 px-16 xl:px-40 gap-10 items-center justify-between">
                    ...
                    <div className="flex flex-col gap-6 px-16 xl:px-40 py-10">
                        <div className="bg-white min-w-fit flex flex-col lg:flex-row lg:justify-around lg:items-center p-6 rounded-lg shadow-lg">
                    ...
                    <div className="px-16 xl:px-40 gap-4 grid grid-cols-2">
                        ...
                        {visits.length > 0 && (
                            <div className="flex flex-col gap-6  py-10">
                                <div className="flex h-24 bg-gray-50 px-16  gap-10 items-center justify-between">
                                    <h1 className="text-2xl font-bold">Visitas del Cliente</h1>
                                </div>
                                <div className="bg-white w-fit p-7 rounded-lg shadow-lg">
